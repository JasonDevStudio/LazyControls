...
{
    /// <summary>
    /// LazyComboBox 类，继承 HandyControl.Controls.ComboBox 控件，实现懒加载和搜索功能。
    /// </summary>
    public class LazyComboBox : HandyControl.Controls.ComboBox
    {
        #region 依赖属性
        ...
        public static readonly DependencyProperty LazyDataSourceProperty =
            DependencyProperty.Register(nameof(LazyDataSource), typeof(IEnumerable), typeof(LazyComboBox),
        ...
        public static readonly DependencyProperty SearchTextProperty =
            DependencyProperty.Register(nameof(SearchText), typeof(string), typeof(LazyComboBox),
        ...
        public static readonly DependencyProperty FirstLoadCountProperty =
            DependencyProperty.Register(nameof(FirstLoadCount), typeof(int), typeof(LazyComboBox),
        ...
        {
            if (d is LazyComboBox lazyListBox && e.NewValue is IEnumerable newValue)
            {
        ...
        {
            if (d is LazyComboBox lazyListBox && e.NewValue is string newValue)
            {
                lazyListBox.ResetLazyLoading();
            }
        }
