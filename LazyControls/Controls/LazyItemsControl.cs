...
{
    /// <summary>
    /// LazyItemsControl 类，继承 ItemsControl 控件，实现懒加载和搜索功能。
    /// </summary>
    public class LazyItemsControl : ItemsControl
    {
        #region 依赖属性
        ...
        public static readonly DependencyProperty LazyDataSourceProperty =
            DependencyProperty.Register(nameof(LazyDataSource), typeof(IEnumerable), typeof(LazyItemsControl),
        ...
        public static readonly DependencyProperty SearchTextProperty =
            DependencyProperty.Register(nameof(SearchText), typeof(string), typeof(LazyItemsControl),
        ...
        public static readonly DependencyProperty FirstLoadCountProperty =
            DependencyProperty.Register(nameof(FirstLoadCount), typeof(int), typeof(LazyItemsControl),
        ...
        {
            if (d is LazyItemsControl lazyItemsControl && e.NewValue is IEnumerable newValue)
            {
                lazyItemsControl.ResetLazyLoading();
            }
        }
        ...
        {
            if (d is LazyItemsControl lazyItemsControl && e.NewValue is string newValue)
            {
                lazyItemsControl.ResetLazyLoading();
            }
        }
        ...
        private IEnumerable ApplySearchFilter(IEnumerable data)
        {
            ...
            return data.Cast<object>().Where(item => item.ToString().Contains(SearchText));
        }
